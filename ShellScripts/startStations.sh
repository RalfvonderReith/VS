...
########################################################################################################
dataSource="D:\Dateien\Studium\VS\Aufgabe 3\VS\datasource\64bit\vessel3"
...
########################################################################################################
stationCmd="erl -pa ebin -eval 'station:start($interfaceName, $mcastAddress, $receivePort, $stationClass, 0, $UTCoffsetMs)'"
